  ...
  <body>
        ...
        <div id="collapsingMobileUser" class="collapse navbar-toggleable-custom dropdown-menu-custom p-x-1 hidden-md-up" role="tabpanel" aria-labelledby="collapsingMobileUser">
          <div class="media m-t-1">
            ...
            <div class="media-body media-middle">
              <h5 class="media-heading">Ika Komalasari</h5>
              <h6>komalaika229@gmail.com</h6>
            </div>
          </div>
    ...
    <header class="jumbotron bg-inverse text-xs-center center-vertically" role="banner">
      <div class="container">
        ...
        <h2 class="m-b-3">Bersih, <em>Wangi</em>, dan Ekonomis <br><a href="ui-elements.html" class="jumbolink">powered by Kus Loundry</a>.</h2>
        <a class="btn btn-secondary-outline m-b-1" href="#" role="button"><span class="icon-sketch"></span>Gabung Bersama Kami</a>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-5">
            <div class="media">
              ...
              <small class="media-body media-bottom">
                &copy; Laundry 2022. <br>
                Designed by Ika Komalasari
              </small>
            </div>
          </div>
          <div class="col-md-6 col-lg-7">
            <ul class="nav nav-inline">
              <li class="nav-item">
                <a class="nav-link" href="">Untuk Memenuhi Mata Kuliah Pemrograman Web<span class="sr-only"></span></a>
              </li>
            </ul>
          </div>
        </div>
